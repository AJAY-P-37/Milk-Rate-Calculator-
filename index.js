...
for (let i = 0; i < 8; i++) {
    ...
    milkType.addEventListener('input', (e) => {
        ...
        let milk_costs = document.querySelector(`#milkTable > table > tbody > tr:nth-child(${i + 1}) > th:nth-child(4)`)
        if (!isNaN(value)) {
        ...
        for (let i = 0; i < 8; i++) {
            ...
            let milk = document.querySelector(`#milkTable > table > tbody > tr:nth-child(${i + 1}) > th:nth-child(4)`)
        ...
        total_value = document.querySelector("#milkTable > table > tfoot > tr > th.total_value")
